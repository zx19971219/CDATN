...
parser.add_argument('--model', type=str, default='MF', help="MF,EMCDR,NCF,MATN,CMF")
...
parser.add_argument('--LS_model', type=str, default='Multi_MLP', help="MLP,Multi_MLP")
...
parser.add_argument('--TMF_batchsize', type=int, default=1024, help="b")
parser.add_argument('--TMF_dim', type=int, default=16, help="b")
parser.add_argument('--TMF_epochs', type=int, default=100, help="b")
parser.add_argument('--TMF_MLP_dim', type=int, default=16, help="b")
...
config.MF_S_path = config.model_path + 'mf_s.pth'
config.MF_T_path = config.model_path + 'mf_t.pth'
config.Mapping_path = config.model_path + 'mapping.pth'